...
class TestExtraFilePhase(helpers.PungiTestCase):
    ...
    def test_runs_copy_files_for_each_variant(self, copy_extra_files):
        ...
        self.assertItemsEqual(
            ...
            [mock.call(compose, 'x86_64', compose.variants['Server'], pkgset_phase.package_sets),
             mock.call(compose, 'amd64', compose.variants['Server'], pkgset_phase.package_sets),
             mock.call(compose, 'amd64', compose.variants['Client'], pkgset_phase.package_sets),
             mock.call(compose, 'x86_64', compose.variants['Everything'], pkgset_phase.package_sets),
             mock.call(compose, 'amd64', compose.variants['Everything'], pkgset_phase.package_sets)]
        )
...
class TestCopyFiles(helpers.PungiTestCase):
    ...
    def test_copy_from_rpm_in_compose(self, get_dir_from_scm, get_file_from_scm):
        ...
        extra_files.copy_extra_files(compose, 'x86_64', compose.variants['Server'], package_sets)
